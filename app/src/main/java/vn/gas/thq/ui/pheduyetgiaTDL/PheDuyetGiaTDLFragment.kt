...
class PheDuyetGiaTDLFragment : BaseFragment(), RequestApproveAdapter.ItemClickListener {
    private lateinit var viewModel: PheDuyetGiaTDLViewModel
...
//    private var type: String = "1"
    ...
    companion object {
        @JvmStatic
        fun newInstance(): PheDuyetGiaTDLFragment {
            val args = Bundle()

            val fragment = PheDuyetGiaTDLFragment()
    ...
    override fun setupViewModel() {
        viewModel =
            ViewModelProviders.of(this,
                ...
                .get(PheDuyetGiaTDLViewModel::class.java)
    }

    override fun initView() {
        tvTitle.text = "Phê duyệt yêu cầu bán hàng TĐL"
...
//        }
    ...
    private fun showDiglogDetailRetailV2() {
        val builder = context?.let { AlertDialog.Builder(it, R.style.AlertDialogNoBG) }
        val inflater = this.layoutInflater
        val dialogView: View = inflater.inflate(R.layout.layout_dialog_item_retail_tdl, null)
        builder?.setView(dialogView)
        val linearLayoutManager = LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false)
