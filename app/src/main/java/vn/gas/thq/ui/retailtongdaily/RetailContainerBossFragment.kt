...
open class RetailContainerBossFragment : BaseFragment() {
    ...
    override fun initView() {
        ...
        childViewController?.pushFragment(
            screen,
            RetailBossFragment.newInstance(step, transferRetailModel)
        )
